CREATE OR REPLACE FUNCTION public.persist_media_watch(p_id uuid, p_title text, p_source jsonb, p_definition jsonb, p_state text, p_revision bigint, p_mutation uuid, p_deleted boolean)
 RETURNS jsonb
 LANGUAGE plpgsql
 SET search_path TO ''
AS $function$
